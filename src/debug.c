...
#define SOUND_LIST_BGM              \
    ...
    X_DS_MUSIC(MUS_DP_TWINLEAF_DAY) \
    X_DS_MUSIC(MUS_DP_SANDGEM_DAY) \
    X_DS_MUSIC(MUS_DP_FLOAROMA_DAY) \
    X_DS_MUSIC(MUS_DP_SOLACEON_DAY) \
    X_DS_MUSIC(MUS_DP_ROUTE225_DAY) \
    X_DS_MUSIC(MUS_DP_VALOR_LAKEFRONT_DAY) \
    X_DS_MUSIC(MUS_DP_JUBILIFE_DAY) \
    X_DS_MUSIC(MUS_DP_CANALAVE_DAY) \
    X_DS_MUSIC(MUS_DP_OREBURGH_DAY) \
    X_DS_MUSIC(MUS_DP_ETERNA_DAY) \
    X_DS_MUSIC(MUS_DP_HEARTHOME_DAY) \
    X_DS_MUSIC(MUS_DP_VEILSTONE_DAY) \
    X_DS_MUSIC(MUS_DP_SUNYSHORE_DAY) \
    X_DS_MUSIC(MUS_DP_SNOWPOINT_DAY) \
    X_DS_MUSIC(MUS_DP_POKEMON_LEAGUE_DAY) \
    X_DS_MUSIC(MUS_DP_FIGHT_AREA_DAY) \
    X_DS_MUSIC(MUS_DP_ROUTE201_DAY) \
    X_DS_MUSIC(MUS_DP_ROAD_B_D) \
    X_DS_MUSIC(MUS_DP_ROUTE205_DAY) \
    X_DS_MUSIC(MUS_DP_ROUTE206_DAY) \
    X_DS_MUSIC(MUS_DP_ROUTE209_DAY) \
    X_DS_MUSIC(MUS_DP_ROUTE210_DAY) \
    X_DS_MUSIC(MUS_DP_ROUTE216_DAY) \
    X_DS_MUSIC(MUS_DP_ROUTE228_DAY) \
    X_DS_MUSIC(MUS_DP_ROWAN) \
    X_DS_MUSIC(MUS_DP_TV_BROADCAST) \
    X_DS_MUSIC(MUS_DP_TWINLEAF_NIGHT) \
    X_DS_MUSIC(MUS_DP_SANDGEM_NIGHT) \
    X_DS_MUSIC(MUS_DP_FLOAROMA_NIGHT) \
    X_DS_MUSIC(MUS_DP_SOLACEON_NIGHT) \
    X_DS_MUSIC(MUS_DP_ROUTE225_NIGHT) \
    X_DS_MUSIC(MUS_DP_VALOR_LAKEFRONT_NIGHT) \
    X_DS_MUSIC(MUS_DP_JUBILIFE_NIGHT) \
    X_DS_MUSIC(MUS_DP_CANALAVE_NIGHT) \
    X_DS_MUSIC(MUS_DP_OREBURGH_NIGHT) \
    X_DS_MUSIC(MUS_DP_ETERNA_NIGHT) \
    X_DS_MUSIC(MUS_DP_HEARTHOME_NIGHT) \
    X_DS_MUSIC(MUS_DP_VEILSTONE_NIGHT) \
    X_DS_MUSIC(MUS_DP_SUNYSHORE_NIGHT) \
    X_DS_MUSIC(MUS_DP_SNOWPOINT_NIGHT) \
    X_DS_MUSIC(MUS_DP_POKEMON_LEAGUE_NIGHT) \
    X_DS_MUSIC(MUS_DP_FIGHT_AREA_NIGHT) \
    X_DS_MUSIC(MUS_DP_ROUTE201_NIGHT) \
    X_DS_MUSIC(MUS_DP_ROUTE203_NIGHT) \
    X_DS_MUSIC(MUS_DP_ROUTE205_NIGHT) \
    X_DS_MUSIC(MUS_DP_ROUTE206_NIGHT) \
    X_DS_MUSIC(MUS_DP_ROUTE209_NIGHT) \
    X_DS_MUSIC(MUS_DP_ROUTE210_NIGHT) \
    X_DS_MUSIC(MUS_DP_ROUTE216_NIGHT) \
    X_DS_MUSIC(MUS_DP_ROUTE228_NIGHT) \
    X_DS_MUSIC(MUS_DP_UNDERGROUND) \
    X_DS_MUSIC(MUS_DP_FLAG_CAPTURED) \
    X_DS_MUSIC(MUS_DP_VICTORY_ROAD) \
    X_DS_MUSIC(MUS_DP_ETERNA_FOREST) \
    X_DS_MUSIC(MUS_DP_OLD_CHATEAU) \
    X_DS_MUSIC(MUS_DP_LAKE_CAVERNS) \
    X_DS_MUSIC(MUS_DP_AMITY_SQUARE) \
    X_DS_MUSIC(MUS_DP_GALACTIC_HQ) \
    X_DS_MUSIC(MUS_DP_GALACTIC_ETERNA_BUILDING) \
    X_DS_MUSIC(MUS_DP_GREAT_MARSH) \
    X_DS_MUSIC(MUS_DP_LAKE) \
    X_DS_MUSIC(MUS_DP_MT_CORONET) \
    X_DS_MUSIC(MUS_DP_SPEAR_PILLAR) \
    X_DS_MUSIC(MUS_DP_STARK_MOUNTAIN) \
    X_DS_MUSIC(MUS_DP_OREBURGH_GATE) \
    X_DS_MUSIC(MUS_DP_OREBURGH_MINE) \
    X_DS_MUSIC(MUS_DP_INSIDE_POKEMON_LEAGUE) \
    X_DS_MUSIC(MUS_DP_HALL_OF_FAME_ROOM) \
    X_DS_MUSIC(MUS_DP_POKE_CENTER_DAY) \
    X_DS_MUSIC(MUS_DP_POKE_CENTER_NIGHT) \
    X_DS_MUSIC(MUS_DP_GYM) \
    X_DS_MUSIC(MUS_DP_ROWAN_LAB) \
    X_DS_MUSIC(MUS_DP_CONTEST_LOBBY) \
    X_DS_MUSIC(MUS_DP_POKE_MART) \
    X_DS_MUSIC(MUS_DP_GAME_CORNER) \
    X_DS_MUSIC(MUS_DP_B_TOWER) \
    X_DS_MUSIC(MUS_DP_TV_STATION) \
    X_DS_MUSIC(MUS_DP_GALACTIC_HQ_BASEMENT) \
    X_DS_MUSIC(MUS_DP_AZURE_FLUTE) \
    X_DS_MUSIC(MUS_DP_HALL_OF_ORIGIN) \
    X_DS_MUSIC(MUS_DP_GTS) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_BOY) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_TWINS) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_INTENSE) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_GALACTIC) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_LADY) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_HIKER) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_RICH) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_SAILOR) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_SUSPICIOUS) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_ACE_TRAINER) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_GIRL) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_CYCLIST) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_ARTIST) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_ELITE_FOUR) \
    X_DS_MUSIC(MUS_DP_ENCOUNTER_CHAMPION) \
    X_DS_MUSIC(MUS_DP_VS_WILD) \
    X_DS_MUSIC(MUS_DP_VS_GYM_LEADER) \
    X_DS_MUSIC(MUS_DP_VS_UXIE_MESPRIT_AZELF) \
    X_DS_MUSIC(MUS_DP_VS_TRAINER) \
    X_DS_MUSIC(MUS_DP_VS_GALACTIC_BOSS) \
    X_DS_MUSIC(MUS_DP_VS_DIALGA_PALKIA) \
    X_DS_MUSIC(MUS_DP_VS_CHAMPION) \
    X_DS_MUSIC(MUS_DP_VS_GALACTIC) \
    X_DS_MUSIC(MUS_DP_VS_RIVAL) \
    X_DS_MUSIC(MUS_DP_VS_ARCEUS) \
    X_DS_MUSIC(MUS_DP_VS_LEGEND) \
    X_DS_MUSIC(MUS_DP_VICTORY_WILD) \
    X_DS_MUSIC(MUS_DP_VICTORY_TRAINER) \
    X_DS_MUSIC(MUS_DP_VICTORY_GYM_LEADER) \
    X_DS_MUSIC(MUS_DP_VICTORY_CHAMPION) \
    X_DS_MUSIC(MUS_DP_VICTORY_GALACTIC) \
    X_DS_MUSIC(MUS_DP_VICTORY_ELITE_FOUR) \
    X_DS_MUSIC(MUS_DP_VS_GALACTIC_COMMANDER) \
    X_DS_MUSIC(MUS_DP_CONTEST) \
    X_DS_MUSIC(MUS_DP_VS_ELITE_FOUR) \
    X_DS_MUSIC(MUS_DP_FOLLOW_ME) \
    X_DS_MUSIC(MUS_DP_RIVAL) \
    X_DS_MUSIC(MUS_DP_LAKE_EVENT) \
    X_DS_MUSIC(MUS_DP_EVOLUTION) \
    X_DS_MUSIC(MUS_DP_LUCAS) \
    X_DS_MUSIC(MUS_DP_DAWN) \
    X_DS_MUSIC(MUS_DP_LEGEND_APPEARS) \
    X_DS_MUSIC(MUS_DP_CATASTROPHE) \
    X_DS_MUSIC(MUS_DP_POKE_RADAR) \
    X_DS_MUSIC(MUS_DP_SURF) \
    X_DS_MUSIC(MUS_DP_CYCLING) \
    X_DS_MUSIC(MUS_DP_LETS_GO_TOGETHER) \
    X_DS_MUSIC(MUS_DP_TV_END) \
    X_DS_MUSIC(MUS_DP_LEVEL_UP) \
    X_DS_MUSIC(MUS_DP_EVOLVED) \
    X_DS_MUSIC(MUS_DP_OBTAIN_KEY_ITEM) \
    X_DS_MUSIC(MUS_DP_OBTAIN_ITEM) \
    X_DS_MUSIC(MUS_DP_CAUGHT_INTRO) \
    X_DS_MUSIC(MUS_DP_DEX_RATING) \
    X_DS_MUSIC(MUS_DP_OBTAIN_BADGE) \
    X_DS_MUSIC(MUS_DP_POKETCH) \
    X_DS_MUSIC(MUS_DP_OBTAIN_TMHM) \
    X_DS_MUSIC(MUS_DP_OBTAIN_ACCESSORY) \
    X_DS_MUSIC(MUS_DP_MOVE_DELETED) \
    X_DS_MUSIC(MUS_DP_HEAL) \
    X_DS_MUSIC(MUS_DP_OBTAIN_BERRY) \
    X_DS_MUSIC(MUS_DP_CONTEST_DRESS_UP) \
    X_DS_MUSIC(MUS_DP_HALL_OF_FAME) \
    X_DS_MUSIC(MUS_DP_INTRO) \
    X_DS_MUSIC(MUS_DP_TITLE) \
    X_DS_MUSIC(MUS_DP_MYSTERY_GIFT) \
    X_DS_MUSIC(MUS_DP_WFC) \
    X_DS_MUSIC(MUS_DP_DANCE_EASY) \
    X_DS_MUSIC(MUS_DP_DANCE_DIFFICULT) \
    X_DS_MUSIC(MUS_DP_CONTEST_RESULTS) \
    X_DS_MUSIC(MUS_DP_CONTEST_WINNER) \
    X_DS_MUSIC(MUS_DP_POFFINS) \
    X_DS_MUSIC(MUS_DP_SLOTS_WIN) \
    X_DS_MUSIC(MUS_DP_SLOTS_JACKPOT) \
    X_DS_MUSIC(MUS_DP_CREDITS) \
    X_DS_MUSIC(MUS_DP_SLOTS_UNUSED) \
    X_DS_MUSIC(MUS_PL_FIGHT_AREA_DAY) \
    X_DS_MUSIC(MUS_PL_TV_BROADCAST) \
    X_DS_MUSIC(MUS_PL_TV_END) \
    X_DS_MUSIC(MUS_PL_INTRO) \
    X_DS_MUSIC(MUS_PL_TITLE) \
    X_DS_MUSIC(MUS_PL_DISTORTION_WORLD) \
    X_DS_MUSIC(MUS_PL_B_ARCADE) \
    X_DS_MUSIC(MUS_PL_B_HALL) \
    X_DS_MUSIC(MUS_PL_B_CASTLE) \
    X_DS_MUSIC(MUS_PL_B_FACTORY) \
    X_DS_MUSIC(MUS_PL_GLOBAL_TERMINAL) \
    X_DS_MUSIC(MUS_PL_LILYCOVE_BOSSA_NOVA) \
    X_DS_MUSIC(MUS_PL_LOOKER) \
    X_DS_MUSIC(MUS_PL_VS_GIRATINA) \
    X_DS_MUSIC(MUS_PL_VS_FRONTIER_BRAIN) \
    X_DS_MUSIC(MUS_PL_VICTORY_FRONTIER_BRAIN) \
    X_DS_MUSIC(MUS_PL_VS_REGI) \
    X_DS_MUSIC(MUS_PL_CONTEST_COOL) \
    X_DS_MUSIC(MUS_PL_CONTEST_SMART) \
    X_DS_MUSIC(MUS_PL_CONTEST_CUTE) \
    X_DS_MUSIC(MUS_PL_CONTEST_TOUGH) \
    X_DS_MUSIC(MUS_PL_CONTEST_BEAUTY) \
    X_DS_MUSIC(MUS_PL_SPIN_TRADE) \
    X_DS_MUSIC(MUS_PL_WIFI_MINIGAMES) \
    X_DS_MUSIC(MUS_PL_WIFI_PLAZA) \
    X_DS_MUSIC(MUS_PL_WIFI_PARADE) \
    X_DS_MUSIC(MUS_PL_GIRATINA_APPEARS_1) \
    X_DS_MUSIC(MUS_PL_GIRATINA_APPEARS_2) \
    X_DS_MUSIC(MUS_PL_MYSTERY_GIFT) \
    X_DS_MUSIC(MUS_PL_TWINLEAF_MUSIC_BOX) \
    X_DS_MUSIC(MUS_PL_OBTAIN_ARCADE_POINTS) \
    X_DS_MUSIC(MUS_PL_OBTAIN_CASTLE_POINTS) \
    X_DS_MUSIC(MUS_PL_OBTAIN_B_POINTS) \
    X_DS_MUSIC(MUS_PL_WIN_MINIGAME) \
    X_DS_MUSIC(MUS_HG_INTRO) \
    X_DS_MUSIC(MUS_HG_TITLE) \
    X_DS_MUSIC(MUS_HG_NEW_GAME) \
    X_DS_MUSIC(MUS_HG_EVOLUTION) \
    X_DS_MUSIC(MUS_HG_EVOLUTION_NO_INTRO) \
    X_DS_MUSIC(MUS_HG_CYCLING) \
    X_DS_MUSIC(MUS_HG_SURF) \
    X_DS_MUSIC(MUS_HG_E_DENDOURIRI) \
    X_DS_MUSIC(MUS_HG_CREDITS) \
    X_DS_MUSIC(MUS_HG_END) \
    X_DS_MUSIC(MUS_HG_NEW_BARK) \
    X_DS_MUSIC(MUS_HG_CHERRYGROVE) \
    X_DS_MUSIC(MUS_HG_VIOLET) \
    X_DS_MUSIC(MUS_HG_AZALEA) \
    X_DS_MUSIC(MUS_HG_GOLDENROD) \
    X_DS_MUSIC(MUS_HG_ECRUTEAK) \
    X_DS_MUSIC(MUS_HG_CIANWOOD) \
    X_DS_MUSIC(MUS_HG_ROUTE29) \
    X_DS_MUSIC(MUS_HG_ROUTE30) \
    X_DS_MUSIC(MUS_HG_ROUTE34) \
    X_DS_MUSIC(MUS_HG_ROUTE38) \
    X_DS_MUSIC(MUS_HG_ROUTE42) \
    X_DS_MUSIC(MUS_HG_VERMILION) \
    X_DS_MUSIC(MUS_HG_PEWTER) \
    X_DS_MUSIC(MUS_HG_CERULEAN) \
    X_DS_MUSIC(MUS_HG_LAVENDER) \
    X_DS_MUSIC(MUS_HG_CELADON) \
    X_DS_MUSIC(MUS_HG_PALLET) \
    X_DS_MUSIC(MUS_HG_CINNABAR) \
    X_DS_MUSIC(MUS_HG_ROUTE1) \
    X_DS_MUSIC(MUS_HG_ROUTE3) \
    X_DS_MUSIC(MUS_HG_ROUTE11) \
    X_DS_MUSIC(MUS_HG_ROUTE24) \
    X_DS_MUSIC(MUS_HG_ROUTE26) \
    X_DS_MUSIC(MUS_HG_POKE_CENTER) \
    X_DS_MUSIC(MUS_HG_POKE_MART) \
    X_DS_MUSIC(MUS_HG_GYM) \
    X_DS_MUSIC(MUS_HG_ELM_LAB) \
    X_DS_MUSIC(MUS_HG_OAK) \
    X_DS_MUSIC(MUS_HG_DANCE_THEATER) \
    X_DS_MUSIC(MUS_HG_GAME_CORNER) \
    X_DS_MUSIC(MUS_HG_B_TOWER) \
    X_DS_MUSIC(MUS_HG_B_TOWER_RECEPTION) \
    X_DS_MUSIC(MUS_HG_SPROUT_TOWER) \
    X_DS_MUSIC(MUS_HG_UNION_CAVE) \
    X_DS_MUSIC(MUS_HG_RUINS_OF_ALPH) \
    X_DS_MUSIC(MUS_HG_NATIONAL_PARK) \
    X_DS_MUSIC(MUS_HG_BURNED_TOWER) \
    X_DS_MUSIC(MUS_HG_BELL_TOWER) \
    X_DS_MUSIC(MUS_HG_LIGHTHOUSE) \
    X_DS_MUSIC(MUS_HG_TEAM_ROCKET_HQ) \
    X_DS_MUSIC(MUS_HG_ICE_PATH) \
    X_DS_MUSIC(MUS_HG_DRAGONS_DEN) \
    X_DS_MUSIC(MUS_HG_ROCK_TUNNEL) \
    X_DS_MUSIC(MUS_HG_VIRIDIAN_FOREST) \
    X_DS_MUSIC(MUS_HG_VICTORY_ROAD) \
    X_DS_MUSIC(MUS_HG_POKEMON_LEAGUE) \
    X_DS_MUSIC(MUS_HG_FOLLOW_ME_1) \
    X_DS_MUSIC(MUS_HG_FOLLOW_ME_2) \
    X_DS_MUSIC(MUS_HG_ENCOUNTER_RIVAL) \
    X_DS_MUSIC(MUS_HG_RIVAL_EXIT) \
    X_DS_MUSIC(MUS_HG_BUG_CONTEST_PREP) \
    X_DS_MUSIC(MUS_HG_BUG_CATCHING_CONTEST) \
    X_DS_MUSIC(MUS_HG_RADIO_ROCKET) \
    X_DS_MUSIC(MUS_HG_ROCKET_TAKEOVER) \
    X_DS_MUSIC(MUS_HG_MAGNET_TRAIN) \
    X_DS_MUSIC(MUS_HG_SS_AQUA) \
    X_DS_MUSIC(MUS_HG_MT_MOON_SQUARE) \
    X_DS_MUSIC(MUS_HG_RADIO_JINGLE) \
    X_DS_MUSIC(MUS_HG_RADIO_LULLABY) \
    X_DS_MUSIC(MUS_HG_RADIO_MARCH) \
    X_DS_MUSIC(MUS_HG_RADIO_UNOWN) \
    X_DS_MUSIC(MUS_HG_RADIO_POKE_FLUTE) \
    X_DS_MUSIC(MUS_HG_RADIO_OAK) \
    X_DS_MUSIC(MUS_HG_RADIO_BUENA) \
    X_DS_MUSIC(MUS_HG_EUSINE) \
    X_DS_MUSIC(MUS_HG_CLAIR) \
    X_DS_MUSIC(MUS_HG_ENCOUNTER_GIRL_1) \
    X_DS_MUSIC(MUS_HG_ENCOUNTER_BOY_1) \
    X_DS_MUSIC(MUS_HG_ENCOUNTER_SUSPICIOUS_1) \
    X_DS_MUSIC(MUS_HG_ENCOUNTER_SAGE) \
    X_DS_MUSIC(MUS_HG_ENCOUNTER_KIMONO_GIRL) \
    X_DS_MUSIC(MUS_HG_ENCOUNTER_ROCKET) \
    X_DS_MUSIC(MUS_HG_ENCOUNTER_GIRL_2) \
    X_DS_MUSIC(MUS_HG_ENCOUNTER_BOY_2) \
    X_DS_MUSIC(MUS_HG_ENCOUNTER_SUSPICIOUS_2) \
    X_DS_MUSIC(MUS_HG_VS_WILD) \
    X_DS_MUSIC(MUS_HG_VS_TRAINER) \
    X_DS_MUSIC(MUS_HG_VS_GYM_LEADER) \
    X_DS_MUSIC(MUS_HG_VS_RIVAL) \
    X_DS_MUSIC(MUS_HG_VS_ROCKET) \
    X_DS_MUSIC(MUS_HG_VS_SUICUNE) \
    X_DS_MUSIC(MUS_HG_VS_ENTEI) \
    X_DS_MUSIC(MUS_HG_VS_RAIKOU) \
    X_DS_MUSIC(MUS_HG_VS_CHAMPION) \
    X_DS_MUSIC(MUS_HG_VS_WILD_KANTO) \
    X_DS_MUSIC(MUS_HG_VS_TRAINER_KANTO) \
    X_DS_MUSIC(MUS_HG_VS_GYM_LEADER_KANTO) \
    X_DS_MUSIC(MUS_HG_VICTORY_TRAINER) \
    X_DS_MUSIC(MUS_HG_VICTORY_WILD) \
    X_DS_MUSIC(MUS_HG_CAUGHT) \
    X_DS_MUSIC(MUS_HG_VICTORY_GYM_LEADER) \
    X_DS_MUSIC(MUS_HG_VS_HO_OH) \
    X_DS_MUSIC(MUS_HG_VS_LUGIA) \
    X_DS_MUSIC(MUS_HG_POKEATHLON_LOBBY) \
    X_DS_MUSIC(MUS_HG_POKEATHLON_START) \
    X_DS_MUSIC(MUS_HG_POKEATHLON_BEFORE) \
    X_DS_MUSIC(MUS_HG_POKEATHLON_EVENT) \
    X_DS_MUSIC(MUS_HG_POKEATHLON_FINALS) \
    X_DS_MUSIC(MUS_HG_POKEATHLON_RESULTS) \
    X_DS_MUSIC(MUS_HG_POKEATHLON_END) \
    X_DS_MUSIC(MUS_HG_POKEATHLON_WINNER) \
    X_DS_MUSIC(MUS_HG_B_FACTORY) \
    X_DS_MUSIC(MUS_HG_B_HALL) \
    X_DS_MUSIC(MUS_HG_B_ARCADE) \
    X_DS_MUSIC(MUS_HG_B_CASTLE) \
    X_DS_MUSIC(MUS_HG_VS_FRONTIER_BRAIN) \
    X_DS_MUSIC(MUS_HG_VICTORY_FRONTIER_BRAIN) \
    X_DS_MUSIC(MUS_HG_WFC) \
    X_DS_MUSIC(MUS_HG_MYSTERY_GIFT) \
    X_DS_MUSIC(MUS_HG_WIFI_PLAZA) \
    X_DS_MUSIC(MUS_HG_WIFI_MINIGAMES) \
    X_DS_MUSIC(MUS_HG_WIFI_PARADE) \
    X_DS_MUSIC(MUS_HG_GLOBAL_TERMINAL) \
    X_DS_MUSIC(MUS_HG_SPIN_TRADE) \
    X_DS_MUSIC(MUS_HG_GTS) \
    X_DS_MUSIC(MUS_HG_ROUTE47) \
    X_DS_MUSIC(MUS_HG_SAFARI_ZONE_GATE) \
    X_DS_MUSIC(MUS_HG_SAFARI_ZONE) \
    X_DS_MUSIC(MUS_HG_ETHAN) \
    X_DS_MUSIC(MUS_HG_LYRA) \
    X_DS_MUSIC(MUS_HG_GAME_CORNER_WIN) \
    X_DS_MUSIC(MUS_HG_KIMONO_GIRL_DANCE) \
    X_DS_MUSIC(MUS_HG_KIMONO_GIRL) \
    X_DS_MUSIC(MUS_HG_HO_OH_APPEARS) \
    X_DS_MUSIC(MUS_HG_LUGIA_APPEARS) \
    X_DS_MUSIC(MUS_HG_SPIKY_EARED_PICHU) \
    X_DS_MUSIC(MUS_HG_SINJOU_RUINS) \
    X_DS_MUSIC(MUS_HG_RADIO_ROUTE101) \
    X_DS_MUSIC(MUS_HG_RADIO_ROUTE201) \
    X_DS_MUSIC(MUS_HG_RADIO_TRAINER) \
    X_DS_MUSIC(MUS_HG_RADIO_VARIETY) \
    X_DS_MUSIC(MUS_HG_VS_KYOGRE_GROUDON) \
    X_DS_MUSIC(MUS_HG_POKEWALKER) \
    X_DS_MUSIC(MUS_HG_VS_ARCEUS) \
    X_DS_MUSIC(MUS_HG_HEAL) \
    X_DS_MUSIC(MUS_HG_LEVEL_UP) \
    X_DS_MUSIC(MUS_HG_OBTAIN_ITEM) \
    X_DS_MUSIC(MUS_HG_OBTAIN_KEY_ITEM) \
    X_DS_MUSIC(MUS_HG_EVOLVED) \
    X_DS_MUSIC(MUS_HG_OBTAIN_BADGE) \
    X_DS_MUSIC(MUS_HG_OBTAIN_TMHM) \
    X_DS_MUSIC(MUS_HG_OBTAIN_ACCESSORY) \
    X_DS_MUSIC(MUS_HG_MOVE_DELETED) \
    X_DS_MUSIC(MUS_HG_OBTAIN_BERRY) \
    X_DS_MUSIC(MUS_HG_DEX_RATING_1) \
    X_DS_MUSIC(MUS_HG_DEX_RATING_2) \
    X_DS_MUSIC(MUS_HG_DEX_RATING_3) \
    X_DS_MUSIC(MUS_HG_DEX_RATING_4) \
    X_DS_MUSIC(MUS_HG_DEX_RATING_5) \
    X_DS_MUSIC(MUS_HG_DEX_RATING_6) \
    X_DS_MUSIC(MUS_HG_OBTAIN_EGG) \
    X_DS_MUSIC(MUS_HG_BUG_CONTEST_1ST_PLACE) \
    X_DS_MUSIC(MUS_HG_BUG_CONTEST_2ND_PLACE) \
    X_DS_MUSIC(MUS_HG_BUG_CONTEST_3RD_PLACE) \
    X_DS_MUSIC(MUS_HG_CARD_FLIP) \
    X_DS_MUSIC(MUS_HG_CARD_FLIP_GAME_OVER) \
    X_DS_MUSIC(MUS_HG_POKEGEAR_REGISTERED) \
    X_DS_MUSIC(MUS_HG_LETS_GO_TOGETHER) \
    X_DS_MUSIC(MUS_HG_POKEATHLON_READY) \
    X_DS_MUSIC(MUS_HG_POKEATHLON_1ST_PLACE) \
    X_DS_MUSIC(MUS_HG_RECEIVE_POKEMON) \
    X_DS_MUSIC(MUS_HG_OBTAIN_ARCADE_POINTS) \
    X_DS_MUSIC(MUS_HG_OBTAIN_CASTLE_POINTS) \
    X_DS_MUSIC(MUS_HG_OBTAIN_B_POINTS) \
    X_DS_MUSIC(MUS_HG_WIN_MINIGAME) \
    X_DS_MUSIC(MUS_BW_GAME_FREAK) \
    X_DS_MUSIC(MUS_BW_INTRO) \
    X_DS_MUSIC(MUS_BW_THE_POKEMON) \
    X_DS_MUSIC(MUS_BW_TITLE) \
    X_DS_MUSIC(MUS_BW_NEW_GAME_1) \
    X_DS_MUSIC(MUS_BW_NEW_GAME_2) \
    X_DS_MUSIC(MUS_BW_BEGINNING) \
    X_DS_MUSIC(MUS_BW_NUVEMA) \
    X_DS_MUSIC(MUS_BW_VS_RIVAL) \
    X_DS_MUSIC(MUS_BW_FOLLOW_ME_1) \
    X_DS_MUSIC(MUS_BW_JUNIPER_1) \
    X_DS_MUSIC(MUS_BW_JUNIPER_LAB) \
    X_DS_MUSIC(MUS_BW_OBTAIN_KEY_ITEM) \
    X_DS_MUSIC(MUS_BW_FRIEND) \
    X_DS_MUSIC(MUS_BW_ROUTE1) \
    X_DS_MUSIC(MUS_BW_VS_WILD) \
    X_DS_MUSIC(MUS_BW_VICTORY_WILD) \
    X_DS_MUSIC(MUS_BW_LEVEL_UP) \
    X_DS_MUSIC(MUS_BW_ACCUMULA) \
    X_DS_MUSIC(MUS_BW_FOLLOW_ME_2) \
    X_DS_MUSIC(MUS_BW_POKE_CENTER) \
    X_DS_MUSIC(MUS_BW_HEAL) \
    X_DS_MUSIC(MUS_BW_DEX_RATING_1) \
    X_DS_MUSIC(MUS_BW_SAGE) \
    X_DS_MUSIC(MUS_BW_ROUTE2_SPRING) \
    X_DS_MUSIC(MUS_BW_ROUTE2_SUMMER) \
    X_DS_MUSIC(MUS_BW_ROUTE2_AUTUMN) \
    X_DS_MUSIC(MUS_BW_ROUTE2_WINTER) \
    X_DS_MUSIC(MUS_BW_XTRAN_CALL) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_YOUNGSTER) \
    X_DS_MUSIC(MUS_BW_VS_TRAINER) \
    X_DS_MUSIC(MUS_BW_VICTORY_TRAINER) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_LASS) \
    X_DS_MUSIC(MUS_BW_OBTAIN_ITEM) \
    X_DS_MUSIC(MUS_BW_STRIATON) \
    X_DS_MUSIC(MUS_BW_DEX_RATING_2) \
    X_DS_MUSIC(MUS_BW_DREAMYARD) \
    X_DS_MUSIC(MUS_BW_DREAMYARD_B1F) \
    X_DS_MUSIC(MUS_BW_PLASMA) \
    X_DS_MUSIC(MUS_BW_VS_PLASMA) \
    X_DS_MUSIC(MUS_BW_VICTORY_PLASMA) \
    X_DS_MUSIC(MUS_BW_EVOLUTION) \
    X_DS_MUSIC(MUS_BW_EVOLUTION_NO_INTRO) \
    X_DS_MUSIC(MUS_BW_EVOLVED) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_TWINS) \
    X_DS_MUSIC(MUS_BW_CHEREN) \
    X_DS_MUSIC(MUS_BW_TROUBLE) \
    X_DS_MUSIC(MUS_BW_NACRENE) \
    X_DS_MUSIC(MUS_BW_DEX_RATING_3) \
    X_DS_MUSIC(MUS_BW_GYM) \
    X_DS_MUSIC(MUS_BW_VS_GYM_LEADER) \
    X_DS_MUSIC(MUS_BW_VS_WINNING) \
    X_DS_MUSIC(MUS_BW_VICTORY_GYM_LEADER) \
    X_DS_MUSIC(MUS_BW_OBTAIN_BADGE) \
    X_DS_MUSIC(MUS_BW_OBTAIN_TMHM) \
    X_DS_MUSIC(MUS_BW_GATE) \
    X_DS_MUSIC(MUS_BW_SKYARROW_BRIDGE) \
    X_DS_MUSIC(MUS_BW_CASTELIA) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_CLERK) \
    X_DS_MUSIC(MUS_BW_ROUTE4_SPRING) \
    X_DS_MUSIC(MUS_BW_ROUTE4_SUMMER) \
    X_DS_MUSIC(MUS_BW_ROUTE4_AUTUMN) \
    X_DS_MUSIC(MUS_BW_ROUTE4_WINTER) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_BACKPACKER) \
    X_DS_MUSIC(MUS_BW_NIMBASA) \
    X_DS_MUSIC(MUS_BW_BIANCA) \
    X_DS_MUSIC(MUS_BW_EMOTION) \
    X_DS_MUSIC(MUS_BW_N) \
    X_DS_MUSIC(MUS_BW_VS_N_1) \
    X_DS_MUSIC(MUS_BW_VS_IN_PINCH) \
    X_DS_MUSIC(MUS_BW_CYCLING) \
    X_DS_MUSIC(MUS_BW_ALDER) \
    X_DS_MUSIC(MUS_BW_DRAWBRIDGE) \
    X_DS_MUSIC(MUS_BW_DRIFTVEIL) \
    X_DS_MUSIC(MUS_BW_COLD_STORAGE) \
    X_DS_MUSIC(MUS_BW_ROUTE6_SPRING) \
    X_DS_MUSIC(MUS_BW_ROUTE6_SUMMER) \
    X_DS_MUSIC(MUS_BW_ROUTE6_AUTUMN) \
    X_DS_MUSIC(MUS_BW_ROUTE6_WINTER) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_PARASOL) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_SCIENTIST) \
    X_DS_MUSIC(MUS_BW_CHARGESTONE_CAVE) \
    X_DS_MUSIC(MUS_BW_CHARGESTONE_CAVE_B1F) \
    X_DS_MUSIC(MUS_BW_CHARGESTONE_CAVE_B2F) \
    X_DS_MUSIC(MUS_BW_MISTRALTON) \
    X_DS_MUSIC(MUS_BW_JUNIPER_2) \
    X_DS_MUSIC(MUS_BW_DEX_RATING_4) \
    X_DS_MUSIC(MUS_BW_MOVE_DELETED) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_PSYCHIC) \
    X_DS_MUSIC(MUS_BW_ICIRRUS) \
    X_DS_MUSIC(MUS_BW_DRAGONSPIRAL_TOWER) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_PLASMA) \
    X_DS_MUSIC(MUS_BW_DRAGONSPIRAL_TOWER_TOP) \
    X_DS_MUSIC(MUS_BW_RELIC_CASTLE) \
    X_DS_MUSIC(MUS_BW_OBTAIN_STONE) \
    X_DS_MUSIC(MUS_BW_TUBELINE_BRIDGE) \
    X_DS_MUSIC(MUS_BW_POKE_MART) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_ROUGHNECK) \
    X_DS_MUSIC(MUS_BW_OPELUCID_BLACK) \
    X_DS_MUSIC(MUS_BW_OPELUCID_WHITE) \
    X_DS_MUSIC(MUS_BW_ROUTE10) \
    X_DS_MUSIC(MUS_BW_VICTORY_ROAD) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_ACE_TRAINER) \
    X_DS_MUSIC(MUS_BW_POKEMON_LEAGUE) \
    X_DS_MUSIC(MUS_BW_VS_ELITE_FOUR) \
    X_DS_MUSIC(MUS_BW_N_CASTLE_APPEARS) \
    X_DS_MUSIC(MUS_BW_N_CASTLE_BRIDGE) \
    X_DS_MUSIC(MUS_BW_N_CASTLE) \
    X_DS_MUSIC(MUS_BW_N_ROOM) \
    X_DS_MUSIC(MUS_BW_LEGEND_COME) \
    X_DS_MUSIC(MUS_BW_LEGEND_BORN) \
    X_DS_MUSIC(MUS_BW_VS_RESHIRAM_ZEKROM) \
    X_DS_MUSIC(MUS_BW_VS_N_2) \
    X_DS_MUSIC(MUS_BW_GHETSIS) \
    X_DS_MUSIC(MUS_BW_VS_GHETSIS) \
    X_DS_MUSIC(MUS_BW_FAREWELL) \
    X_DS_MUSIC(MUS_BW_CREDITS) \
    X_DS_MUSIC(MUS_BW_LOOKER) \
    X_DS_MUSIC(MUS_BW_OBTAIN_EGG) \
    X_DS_MUSIC(MUS_BW_ROYAL_UNOVA) \
    X_DS_MUSIC(MUS_BW_WFC) \
    X_DS_MUSIC(MUS_BW_GLOBAL_TERMINAL) \
    X_DS_MUSIC(MUS_BW_GTS) \
    X_DS_MUSIC(MUS_BW_SPIN_TRADE) \
    X_DS_MUSIC(MUS_BW_UNITY_TOWER) \
    X_DS_MUSIC(MUS_BW_DEX_RATING_5) \
    X_DS_MUSIC(MUS_BW_GEAR_STATION) \
    X_DS_MUSIC(MUS_BW_BATTLE_SUBWAY) \
    X_DS_MUSIC(MUS_BW_VS_SUBWAY_TRAINER) \
    X_DS_MUSIC(MUS_BW_OBTAIN_B_POINTS) \
    X_DS_MUSIC(MUS_BW_MUSICAL_THEATER) \
    X_DS_MUSIC(MUS_BW_OBTAIN_ACCESSORY) \
    X_DS_MUSIC(MUS_BW_MUSICAL_DRESS_UP) \
    X_DS_MUSIC(MUS_BW_MUSICAL_CURTAIN_RAISES) \
    X_DS_MUSIC(MUS_BW_MUSICAL_STARDOM) \
    X_DS_MUSIC(MUS_BW_MUSICAL_FOREST_STROLL) \
    X_DS_MUSIC(MUS_BW_MUSICAL_A_SWEET_SOIREE) \
    X_DS_MUSIC(MUS_BW_MUSICAL_EXCITING_NIMBASA) \
    X_DS_MUSIC(MUS_BW_MUSICAL_DLC_MUNNA) \
    X_DS_MUSIC(MUS_BW_MUSICAL_DLC_SMASH) \
    X_DS_MUSIC(MUS_BW_MUSICAL_DLC_FESTA) \
    X_DS_MUSIC(MUS_BW_MUSICAL_DLC_RELIC) \
    X_DS_MUSIC(MUS_BW_MUSICAL_DLC_RUNPA) \
    X_DS_MUSIC(MUS_BW_FERRIS_WHEEL) \
    X_DS_MUSIC(MUS_BW_FEELING_CHECK) \
    X_DS_MUSIC(MUS_BW_FEELING_CHECK_HIGH) \
    X_DS_MUSIC(MUS_BW_FEELING_CHECK_MEDIUM) \
    X_DS_MUSIC(MUS_BW_FEELING_CHECK_LOW) \
    X_DS_MUSIC(MUS_BW_VS_LEGEND) \
    X_DS_MUSIC(MUS_BW_ANVILLE_TOWN) \
    X_DS_MUSIC(MUS_BW_MARVELOUS_BRIDGE) \
    X_DS_MUSIC(MUS_BW_ROUTE12_SPRING) \
    X_DS_MUSIC(MUS_BW_ROUTE12_SUMMER) \
    X_DS_MUSIC(MUS_BW_ROUTE12_AUTUMN) \
    X_DS_MUSIC(MUS_BW_ROUTE12_WINTER) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_CYCLIST) \
    X_DS_MUSIC(MUS_BW_POKETRANSFER_LAB) \
    X_DS_MUSIC(MUS_BW_POKETRANSFER_BOX) \
    X_DS_MUSIC(MUS_BW_POKETRANSFER_GAME) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_POKEFAN) \
    X_DS_MUSIC(MUS_BW_BLACK_CITY) \
    X_DS_MUSIC(MUS_BW_WHITE_FOREST) \
    X_DS_MUSIC(MUS_BW_GAME_SYNC) \
    X_DS_MUSIC(MUS_BW_ENTRALINK) \
    X_DS_MUSIC(MUS_BW_FUNFEST_START) \
    X_DS_MUSIC(MUS_BW_ENTRALINK_VISIT) \
    X_DS_MUSIC(MUS_BW_FUNFEST_CLEAR) \
    X_DS_MUSIC(MUS_BW_FUNFEST_FAILED) \
    X_DS_MUSIC(MUS_BW_ENCOUNTER_GENTLEMAN) \
    X_DS_MUSIC(MUS_BW_UNDELLA_SPRING) \
    X_DS_MUSIC(MUS_BW_UNDELLA_SUMMER) \
    X_DS_MUSIC(MUS_BW_CYNTHIA) \
    X_DS_MUSIC(MUS_BW_VS_CYNTHIA) \
    X_DS_MUSIC(MUS_BW_LOSTLORN_FOREST) \
    X_DS_MUSIC(MUS_BW_VS_WILD_STRONG) \
    X_DS_MUSIC(MUS_BW_SURF) \
    X_DS_MUSIC(MUS_BW_ABYSSAL_RUINS) \
    X_DS_MUSIC(MUS_BW_LACUNOSA) \
    X_DS_MUSIC(MUS_BW_VILLAGE_BRIDGE) \
    X_DS_MUSIC(MUS_BW_MYSTERY_GIFT) \
    X_DS_MUSIC(MUS_BW_BATTLE_COMPETITION) \
    X_DS_MUSIC(MUS_BW_ROCKET) \
    X_DS_MUSIC(MUS_BW_VS_KYUREM) \
    X_DS_MUSIC(MUS_BW_DEX_RATING_6) \
    X_DS_MUSIC(MUS_BW_VS_CHAMPION) \
    X_DS_MUSIC(MUS_BW_VICTORY_CHAMPION) \
    X_DS_MUSIC(MUS_BW_HALL_OF_FAME) \
    X_DS_MUSIC(MUS_BW_RELIC_SONG) \
    X_DS_MUSIC(MUS_BW_VS_WCS_CHAMPION) \
    X_DS_MUSIC(MUS_BW_OBTAIN_BERRY)
...
#if SND_DS_MUSIC
#define X_DS_MUSIC(songId) static const u8 sBGMName_##songId[] = _(#songId);
#else
#define X_DS_MUSIC(songId)
#endif
SOUND_LIST_BGM
#undef X
...
#if SND_DS_MUSIC
#define X_DS_MUSIC(songId) [songId - START_MUS] = sBGMName_##songId,
#else
#define X_DS_MUSIC(songId)
#endif
static const u8 *const sBGMNames[END_MUS - START_MUS + 1] =
