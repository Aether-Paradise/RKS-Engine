        ...
        case 3:
             ...
             && GetMonData(mon, MON_DATA_LEVEL) != MAX_LEVEL)
            {
                ...
                if (param == 0) // Rare Candy
                {
                    ...
                    dataUnsigned = gExperienceTables[growthRate][GetMonData(mon, MON_DATA_LEVEL) + itemCount];
                }
        ...
        for (i = 0; i < count; i++)
        {
            ...
            else
            {
                ...
                if (itemCommon == itemRare && itemCommon != ITEM_NONE)
                {
                    ...
                    SetMonData(&gParties[B_TRAINER_1][i], MON_DATA_HELD_ITEM, &itemCommon);
                }
                else
                {
                    if (rnd < chanceNoItem)
                    ...
                    if (rnd < chanceNotRare)
                        ...
                        SetMonData(&gParties[B_TRAINER_1][i], MON_DATA_HELD_ITEM, &itemRare);
                }
            }
        }
    }
