...
ASSUMPTIONS
{
    ...
    ASSUME(GetItemHoldEffectParam(ITEM_ELECTRIC_SEED) == HOLD_EFFECT_PARAM_ELECTRIC_TERRAIN);
    ...
    ASSUME(GetItemHoldEffect(ITEM_MISTY_SEED) == HOLD_EFFECT_TERRAIN_SEED);
    ASSUME(GetItemHoldEffectParam(ITEM_MISTY_SEED) == HOLD_EFFECT_PARAM_MISTY_TERRAIN);
    ASSUME(GetItemHoldEffect(ITEM_PSYCHIC_SEED) == HOLD_EFFECT_TERRAIN_SEED);
    ASSUME(GetItemHoldEffectParam(ITEM_PSYCHIC_SEED) == HOLD_EFFECT_PARAM_PSYCHIC_TERRAIN);
