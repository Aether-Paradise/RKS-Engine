...
#define EC_WORD_COLOR         ((EC_GROUP_STATUS << EC_MASK_BITS) | 1)
#define EC_WORD_ALT_COLOR     ((EC_GROUP_STATUS << EC_MASK_BITS) | 2)
#define EC_WORD_BEAUTIFUL     ((EC_GROUP_STATUS << EC_MASK_BITS) | 3)
#define EC_WORD_BEAUTY        ((EC_GROUP_STATUS << EC_MASK_BITS) | 4)
#define EC_WORD_PSYCHIC       ((EC_GROUP_STATUS << EC_MASK_BITS) | 5)
#define EC_WORD_FIGHTING      ((EC_GROUP_STATUS << EC_MASK_BITS) | 6)
#define EC_WORD_SMART         ((EC_GROUP_STATUS << EC_MASK_BITS) | 7)
#define EC_WORD_SMARTNESS     ((EC_GROUP_STATUS << EC_MASK_BITS) | 8)
#define EC_WORD_COOL          ((EC_GROUP_STATUS << EC_MASK_BITS) | 9)
#define EC_WORD_COOLNESS      ((EC_GROUP_STATUS << EC_MASK_BITS) | 10)
#define EC_WORD_CUTE          ((EC_GROUP_STATUS << EC_MASK_BITS) | 11)
#define EC_WORD_CUTENESS      ((EC_GROUP_STATUS << EC_MASK_BITS) | 12)
#define EC_WORD_GRASS         ((EC_GROUP_STATUS << EC_MASK_BITS) | 13)
#define EC_WORD_GHOST         ((EC_GROUP_STATUS << EC_MASK_BITS) | 14)
#define EC_WORD_ICE           ((EC_GROUP_STATUS << EC_MASK_BITS) | 15)
#define EC_WORD_GROUND        ((EC_GROUP_STATUS << EC_MASK_BITS) | 16)
#define EC_WORD_TYPE          ((EC_GROUP_STATUS << EC_MASK_BITS) | 17)
#define EC_WORD_TOUGH         ((EC_GROUP_STATUS << EC_MASK_BITS) | 18)
#define EC_WORD_TOUGHNESS     ((EC_GROUP_STATUS << EC_MASK_BITS) | 19)
#define EC_WORD_ELECTRIC      ((EC_GROUP_STATUS << EC_MASK_BITS) | 20)
#define EC_WORD_POISON        ((EC_GROUP_STATUS << EC_MASK_BITS) | 21)
#define EC_WORD_DRAGON        ((EC_GROUP_STATUS << EC_MASK_BITS) | 22)
#define EC_WORD_NORMAL        ((EC_GROUP_STATUS << EC_MASK_BITS) | 23)
#define EC_WORD_STEEL         ((EC_GROUP_STATUS << EC_MASK_BITS) | 24)
#define EC_WORD_SHINE         ((EC_GROUP_STATUS << EC_MASK_BITS) | 25)
#define EC_WORD_FLYING        ((EC_GROUP_STATUS << EC_MASK_BITS) | 26)
#define EC_WORD_PKRS          ((EC_GROUP_STATUS << EC_MASK_BITS) | 27)
#define EC_WORD_FIRE          ((EC_GROUP_STATUS << EC_MASK_BITS) | 28)
#define EC_WORD_WATER         ((EC_GROUP_STATUS << EC_MASK_BITS) | 29)
#define EC_WORD_BUG           ((EC_GROUP_STATUS << EC_MASK_BITS) | 30)
#define EC_WORD_ROCK          ((EC_GROUP_STATUS << EC_MASK_BITS) | 31)
#define EC_WORD_PATTERN       ((EC_GROUP_STATUS << EC_MASK_BITS) | 32)

#define EC_WORD_FAIRY         ((EC_GROUP_STATUS << EC_MASK_BITS) | 33)
