...
enum ConfigBagUI
{
    CONFIG_BAG_UI_EMERALD,
    CONFIG_BAG_UI_FRLG,
};

#define FRLG_I_USE_FRLG_BAG                      CONFIG_BAG_UI_EMERALD
#define FRLG_I_HMS_FIRST                         FRLG_I_USE_FRLG_BAG // If TRUE, HMs will always come first in the TM Case, as well as sorting by index outside of it.
...
// CI config override
#include "config/override/frlg_bag.h"
